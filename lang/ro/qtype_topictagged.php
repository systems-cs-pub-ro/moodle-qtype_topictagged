...
$string['pluginnamesummary'] = 'Selectează o întrebare din banca de întrebări cu dificultatea si topicul ' .
...
$string['settagsempty'] = 'Nu s-a selectat un topic';
...
$string['download_button'] = 'Descărcați';
...
$string['settags_help'] = 'Topicurile sunt taguri definite de utilizatori care sunt adăugate întrebărilor în banca de întrebări. Ele trebuie să își păstreze forma în care au fost scrise când au fost adăugate întrebărilor, sau nu se vor găsi întrebări care să respecte condițiile. Topicurile sunt case insensitive și se poate alege un singur topic pentru o întrebare.';
...
$string['available_questoins'] = 'Numărul de întrebări valabile:';
